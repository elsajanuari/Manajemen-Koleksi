<x-app-layout>
    <div class="max-w-7xl mx-auto px-3 sm:px-4 py-4 sm:py-6">
        ...
        <nav class="flex flex-wrap items-center gap-2 text-sm text-gray-500 mb-6">
            ...
            <span class="text-gray-700 font-medium">Tambah Tiket</span>
        </nav>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="px-4 sm:px-6 py-4 sm:py-5 bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-gray-200">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-lg sm:text-xl font-bold text-gray-900">Tambah Tiket Baru</h1>
                        <p class="text-sm text-gray-500 mt-0.5">Isi semua informasi tiket dengan lengkap</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-4 sm:p-6">
                ...
                <form action="{{ route('tickets.store') }}" method="POST" enctype="multipart/form-data" id="ticket-form" novalidate>
                    @csrf
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
                        ...
                        <div class="space-y-6 order-1">
                            ...
                            <div>
                                ...
                                <input type="text" name="nama_tiket" id="nama_tiket" value="{{ old('nama_tiket') }}"
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select name="jenis_tiket" id="jenis_tiket"
                                        ...
                                        <option value="reguler" {{ old('jenis_tiket') === 'reguler' ? 'selected' : '' }}>Reguler</option>
                                        <option value="event" {{ old('jenis_tiket') === 'event' ? 'selected' : '' }}>Event</option>
                                    </select>
                                    @error('jenis_tiket')<p class="text-red-500 text-xs mt-1">{{ $message }}</p>@enderror
                                </div>

                                <div id="sub-jenis-wrap" class="hidden">
                                    <label class="block text-sm font-medium text-gray-700 mb-1.5">
                                    ...
                                    <select name="sub_jenis" id="sub_jenis"
                                        ...
                                        <option value="Sunday Painting" {{ old('sub_jenis') === 'Sunday Painting' ? 'selected' : '' }}>Sunday Painting</option>
                                        <option value="Pameran" {{ old('sub_jenis') === 'Pameran' ? 'selected' : '' }}>Pameran</option>
                                        <option value="Workshop" {{ old('sub_jenis') === 'Workshop' ? 'selected' : '' }}>Workshop</option>
                                        <option value="Lainnya" {{ old('sub_jenis') === 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                                    </select>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div id="sub-kategori-wrap" class="hidden">
                                    <label class="block text-sm font-medium text-gray-700 mb-1.5">
                                    ...
                                    <select name="sub_kategori" id="sub_kategori"
                                        ...
                                        <option value="Pameran Rutin" {{ old('sub_kategori') === 'Pameran Rutin' ? 'selected' : '' }}>Pameran Rutin</option>
                                        <option value="Pameran Berkala" {{ old('sub_kategori') === 'Pameran Berkala' ? 'selected' : '' }}>Pameran Berkala</option>
                                        <option value="Pameran Museum" {{ old('sub_kategori') === 'Pameran Museum' ? 'selected' : '' }}>Pameran Museum</option>
                                    </select>
                            ...
                            <div id="minimal-anggota-wrap" class="hidden">
                                ...
                                <div class="mt-4">
                                    ...
                                    <input type="number" name="minimal_anggota" id="minimal_anggota" min="5" value="{{ old('minimal_anggota', 5) }}"
                            ...
                            <div>
                                ...
                                <textarea name="deskripsi" id="deskripsi" rows="3"
                                    ...
                                    placeholder="Deskripsi singkat tentang tiket" required>{{ old('deskripsi') }}</textarea>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <input type="date" name="tanggal_mulai" id="tanggal_mulai_input" value="{{ old('tanggal_mulai') }}" min="{{ date('Y-m-d') }}"
                                        class="w-full rounded-lg border-gray-300 px-3.5 py-2.5 text-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition" required>
                                ...
                                <div>
                                    ...
                                    <input type="date" name="tanggal_selesai" id="tanggal_selesai_input" value="{{ old('tanggal_selesai') }}"
                                        class="w-full rounded-lg border-gray-300 px-3.5 py-2.5 text-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition" required>
                            ...
                            <div>
                                ...
                                <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-400 transition cursor-pointer"
                                    ...
                                    <div id="img-preview-wrap" class="hidden mb-3">
                                        <img id="img-preview" class="h-24 mx-auto rounded-lg object-cover">
                                    </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function refreshVisibility() {
            ...
            const currentKategori = kategoriSelect.value || "{{ old('kategori_pengunjung') }}";
