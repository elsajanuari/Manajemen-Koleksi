...
<body>
    ...
    <div class="header">
        ...
        <div class="header-right">
            <div class="doc-title">Laporan Penjualan Tiket</div>
    ...
    {{-- TABLE --}}
    <div class="section-title">Rincian Penjualan Tiket</div>
    <table>
        <thead>
            <tr>
                <th width="5%">No</th>
                <th width="35%">Jenis Tiket</th>
                <th width="20%" class="text-right">Harga</th>
                <th width="20%" class="text-right">Jumlah Terjual</th>
        ...
        <tbody>
            @forelse($data as $index => $item)
                <tr>
                    ...
                    <td class="text-right">{{ number_format($item['jumlah_terjual']) }}</td>
