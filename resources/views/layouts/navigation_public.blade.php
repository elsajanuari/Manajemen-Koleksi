...
<nav x-data="{ mobileOpen: false }" class="bg-white border-b border-gray-200 shadow-sm font-sans sticky top-0 z-50">
        ...
        <div class="flex justify-between items-center h-16 w-full gap-4">
            ...
            <div class="hidden md:flex items-center gap-1 flex-shrink-0 ml-auto">
                ...
                <a href="{{ route('register') }}"
                   class="px-5 py-2 rounded-lg text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 shadow-sm hover:shadow transition-all duration-200">
                    Daftar
                </a>
            </div>
    ...
    <div x-show="mobileOpen"
        ...
        <a href="{{ route('register') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 transition-all duration-200">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
