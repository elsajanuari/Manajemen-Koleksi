    ...
    <div class="pr-root">
                ...
                <div class="pr-hero-top">
                    <div>
                        <div class="pr-breadcrumb">
                            ...
                            <span class="pr-breadcrumb-cur">Riwayat Penyewaan</span>
                        </div>
                        ...
                        <p class="pr-hero-sub">Seluruh penyewaan yang telah selesai, ditolak, maupun dibatalkan tersimpan di sini.</p>
                        <a href="{{ route('penyewaan.index') }}" class="pr-hero-btn">
        ...
        <div class="pr-content">
            ...
            <div class="pr-filter-card">
                <form method="GET" action="{{ route('penyewaan.riwayat') }}">
                    <div class="pr-filter-row">
                        ...
                        <div class="pr-filter-actions">
                            ...
                            @if($filterStatus || $filterDari || $filterSampai)
                                <a href="{{ route('penyewaan.riwayat') }}" class="pr-filter-btn pr-filter-btn-reset">
            ...
            <div class="pr-card">
                ...
                @if($riwayat->isEmpty())
                    <div class="pr-empty">
                        ...
                        @if($filterStatus || $filterDari || $filterSampai)
                            <a href="{{ route('penyewaan.riwayat') }}" class="pr-empty-cta">Reset Filter</a>
                        @endif
                    </div>
                @else
                    ...
                    <div class="pr-item">
                        ...
                        <div class="pr-item-right">
                            <div class="pr-item-actions">
                                <a href="{{ route('penyewaan.requests.show', $item) }}" class="pr-btn pr-btn-navy">
