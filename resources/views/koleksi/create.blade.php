        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="text-lg font-semibold text-gray-900 mb-4">Tambah Koleksi</h3>
                    ...
                    <form method="POST" action="{{ route('koleksi.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <span class="text-xs text-red-600 font-medium">Wajib diisi</span>
                                <x-text-input id="seniman" name="seniman" type="text" class="mt-1 block w-full" value="{{ old('seniman') }}" required />
                            ...
                            <div id="lukisan-fields" style="{{ old('kategori') === 'lukisan' ? '' : 'display:none' }}">
                                <div>
                                    ...
                                    <x-text-input id="teknik_media" name="teknik_media" type="text" class="mt-1 block w-full" value="{{ old('teknik_media') }}" />
                                ...
                                <div class="mt-4">
                                    ...
                                    <span class="text-xs text-red-600 font-medium">Wajib diisi untuk lukisan</span>
                                    <x-text-input id="ukuran_lukisan" name="ukuran_lukisan" type="text" class="mt-1 block w-full" value="{{ old('ukuran_lukisan') }}" />
                                    <x-input-error :messages="$errors->get('ukuran_lukisan')" class="mt-2" />
                                </div>
                            </div>

                            <div>
                                <x-input-label for="tahun" id="tahun-label" :value="strtolower(old('kategori') ?? '') === 'buku' ? __('Tahun Terbit') : __('Tahun Pembuatan')" />
                                <span class="text-xs text-red-600 font-medium">Wajib diisi</span>
                                <x-text-input id="tahun" name="tahun" type="number" min="1500" max="{{ date('Y') }}" step="1" placeholder="Contoh: 2024" class="mt-1 block w-full" value="{{ old('tahun') }}" required />
                            ...
                            <div>
                                <x-input-label for="foto" :value="__('Foto Koleksi')" />
                                <span class="text-xs text-red-600 font-medium">Wajib diisi</span>
                                <input id="foto" name="foto" type="file" accept="image/*" class="mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100" required />
                            ...
                            <div>
                                ...
                                <select id="status_sewa" name="status_sewa" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                                    ...
                                    @foreach (\App\Models\Koleksi::statusSewaOptions() as $value => $option)
                                        <option value="{{ $value }}" {{ old('status_sewa') === $value ? 'selected' : '' }}>{{ $option['label'] }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                <div id="daily_rate_wrapper">
                                    ...
                                    <x-text-input id="daily_rate" name="daily_rate" type="number" min="0" class="mt-1 block w-full" value="{{ old('daily_rate', 0) }}" />
                                ...
                                <div id="sale_price_wrapper">
                                    ...
                                    <x-text-input id="sale_price" name="sale_price" type="number" min="0" class="mt-1 block w-full" value="{{ old('sale_price') }}" />
                                ...
                                <div id="weight_gram_wrapper">
                                    ...
                                    <x-text-input id="weight_gram" name="weight_gram" type="number" min="1" class="mt-1 block w-full" value="{{ old('weight_gram', 1000) }}" required />
                            ...
                            <div>
                                ...
                                <select id="lokasi" name="lokasi" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                                    ...
                                    @foreach (\App\Models\Koleksi::lokasiOptions() as $value => $option)
                                        <option value="{{ $value }}" {{ old('lokasi') === $value ? 'selected' : '' }}>{{ $option['label'] }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <a href="{{ route('koleksi.index') }}" class="text-sm text-gray-600 hover:text-gray-900">{{ __('Batal') }}</a>
                            </div>
                        </div>
                    </form>
