<x-app-layout>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .pr-hero-btn { display:inline-flex; align-items:center; gap:.4rem; padding:.6rem 1.2rem; border-radius:.875rem; font-size:.8rem; font-weight:600; font-family:'DM Sans',sans-serif; text-decoration:none; transition:all .18s; background:rgba(255,255,255,.1); border:1px solid rgba(255,255,255,.15); color:rgba(255,255,255,.85); white-space:nowrap; margin-top:1rem; }
        ...
        .pr-filter-select:focus { border-color:#93c5fd; }
    ...
    <div class="pr-root">
                ...
                <div class="pr-hero-top">
                    <div>
                        <div class="pr-breadcrumb">
                            <a href="{{ route('pengelola.penyewaan.index') }}">Dashboard Penyewaan</a>
                        ...
                        <p class="pr-hero-sub">Seluruh penyewaan yang telah selesai, ditolak, maupun dibatalkan oleh semua penyewa.</p>
                        <a href="{{ route('pengelola.penyewaan.index') }}" class="pr-hero-btn">
        ...
        <div class="pr-content">
            ...
            <div class="pr-filter-card">
                <form method="GET" action="{{ route('pengelola.penyewaan.riwayat') }}">
                    <div class="pr-filter-row">
                        ...
                        <div class="pr-filter-actions">
                            ...
                            @if($filterStatus || $filterDari || $filterSampai)
                                <a href="{{ route('pengelola.penyewaan.riwayat') }}" class="pr-filter-btn pr-filter-btn-reset">
            ...
            <div class="pr-card">
                <div class="pr-card-head">
                    <div class="pr-card-title">Daftar Riwayat Penyewaan</div>
                ...
                @if($riwayat->isEmpty())
                    <div class="pr-empty">
                        ...
                        <p>
                            ...
                            @else
                                Belum ada penyewaan selesai, ditolak, atau dibatalkan.
                            @endif
                        </p>
                        @if($filterStatus || $filterDari || $filterSampai)
                            <a href="{{ route('pengelola.penyewaan.riwayat') }}" class="pr-empty-cta">Reset Filter</a>
                        @endif
                    </div>
                @else
                    ...
                    @php
                        ...
                        $tanggalAkhir = match($item->status) {
                            'selesai'    => $item->completed_at ?? $item->updated_at,
                    ...
                    <div class="pr-item">
                        <div class="pr-item-left">
                            <div class="pr-item-thumb">
                                @if($item->painting->image_path ?? null)
                                    <img src="{{ asset('storage/' . $item->painting->image_path) }}" alt="{{ $item->painting->title }}">
                                @elseif($item->painting->image_url ?? null)
                            ...
                            <div style="min-width:0;">
                                <div style="display:flex;align-items:center;gap:.5rem;flex-wrap:wrap;margin-bottom:.2rem;">
                                    <span class="pr-item-id">SW-{{ str_pad($item->id, 5, '0', STR_PAD_LEFT) }}</span>
                                ...
                                <div class="pr-item-artist">
                                    {{ $item->painting->artist ?? '' }}
                                    &bull;
                                    {{ $item->rental_type === 'instansi' ? ($item->nama_instansi ?? '-') : ($item->contact_name ?? '-') }}
                                    &bull;
                                    {{ $item->rental_type === 'instansi' ? 'Instansi' : 'Perseorangan' }}
                                </div>
                                <div class="pr-item-meta">
                                    ...
                                    <div class="pr-meta-cell">
                                        <div class="pr-meta-lbl">Periode Sewa</div>
                                        <div class="pr-meta-val">
                        ...
                        <div class="pr-item-right">
                            <div class="pr-item-actions">
                                <a href="{{ route('pengelola.penyewaan.show', $item) }}" class="pr-btn pr-btn-navy">
