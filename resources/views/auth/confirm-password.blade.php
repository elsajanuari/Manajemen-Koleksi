<x-guest-layout>
    ...
    <div class="hidden md:flex flex-col justify-between w-2/5 bg-blue-700 p-10 relative overflow-hidden">
        ...
        <div class="relative z-10">
            ...
            <h1 class="text-white text-2xl font-medium leading-snug mb-3">Konfirmasi<br>Keamanan</h1>
            <p class="text-white/60 text-sm leading-relaxed">Ini adalah area aman aplikasi. Harap konfirmasi kata sandi Anda sebelum melanjutkan.</p>
        </div>
    ...
    <div class="flex-1 bg-white p-10 flex flex-col justify-center">
        <h2 class="text-xl font-medium text-gray-800 mb-1">Konfirmasi kata sandi</h2>
        <p class="text-sm text-gray-400 mb-7">Masukkan kata sandi Anda untuk melanjutkan</p>
        ...
        <form method="POST" action="{{ route('password.confirm') }}">
            ...
            <p class="text-center text-xs text-gray-400 mt-5">
                ...
                <a href="{{ route('landing') }}" class="text-blue-600 hover:underline">Kembali</a>
            </p>
        </form>
    </div>
</x-guest-layout>