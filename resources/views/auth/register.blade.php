<x-guest-layout>
    ...
    <div class="hidden md:flex flex-col justify-between w-2/5 bg-blue-700 p-10 relative overflow-hidden">
        ...
        <div class="relative z-10">
            ...
            <h1 class="text-white text-2xl font-medium leading-snug mb-3">Halo,<br>Pengunjung!</h1>
            <p class="text-white/60 text-sm leading-relaxed">Daftar sekarang dan nikmati kemudahan mengakses tiket, pameran, koleksi seni, pembelian karya, hingga penyewaan lukisan dalam satu platform terintegrasi.</p>
        </div>
    ...
    <div class="flex-1 bg-white p-10">
        <h2 class="text-xl font-medium text-gray-800 mb-1">Buat akun baru</h2>
        <p class="text-sm text-gray-400 mb-7">Isi data berikut untuk mendaftar</p>

        <form method="POST" action="{{ route('register') }}">
            @csrf

            <div class="mb-4">
                <x-input-label for="name" :value="__('Nama Lengkap')" class="text-xs uppercase tracking-widest text-gray-500 font-medium" />
