<x-guest-layout>
    ...
    <div class="hidden md:flex flex-col justify-between w-2/5 bg-blue-700 p-10 relative overflow-hidden">
        ...
        <div class="relative z-10">
            <div class="flex items-center gap-2 mb-10">
                <img src="{{ asset('images/logo-museum.png') }}" alt="Logo Museum" class="h-8 w-auto">
                <span class="text-white font-medium text-sm tracking-wide">{{ config('app.name', 'Museum MK Lesmana') }}</span>
            </div>
            <h1 class="text-white text-2xl font-medium leading-snug mb-3">Lupa kata<br>sandi?</h1>
            <p class="text-white/60 text-sm leading-relaxed">Tenang, kami akan kirimkan tautan reset ke email Anda. Periksa inbox setelah mengirim.</p>
        </div>
    ...
    <div class="flex-1 bg-white p-10 flex flex-col justify-center">
        ...
        <p class="text-sm text-gray-400 mb-7">Masukkan email Anda dan kami akan mengirimkan tautan reset.</p>
        ...
        <form method="POST" action="{{ route('password.email') }}">
            ...
            <div class="mb-5">
                ...
                <div class="relative mt-1">
                    ...
                    <x-text-input id="email" class="block w-full pl-9" type="email" name="email" :value="old('email')" required autofocus />
                </div>
